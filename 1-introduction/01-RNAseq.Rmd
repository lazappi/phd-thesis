...
that tag all the molecules in a samples and allow multiple samples to be
sequenced at once. It has become standard practice to perform paired-end
sequencing where a section of sequence is read from one end of a molecule
...
single stranded DNA attached to the flow cell and one end.
