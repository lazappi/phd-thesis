...
sequence of adenine nucleotides (a poly(A) tail) where transcription ends (the
3' end) to mark a mature mRNA molecule. This splicing process allows multiple
forms of a protein to be produced from a single gene by selecting which exons
are retained or removed. A mature mRNA transcript is converted to a protein in
a complex structure called the ribosome which is made up of specialised RNA and
proteins. The conversion process is known as translation because the
information encoded by nucleic acids in RNA is translated to information stored
