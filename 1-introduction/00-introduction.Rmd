...
Once a path has been inferred important genes can be identified by looking for
those that change expression over the course of the path. These genes can be
important in their own right as they describe the biology of the path, but that
can also be used to identify cell types at the end points of the path or where
the path branches.
```
