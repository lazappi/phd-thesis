...
reads to align in different locations in the geneome. The alignment step is
...
potentially produce more accurate quantification at the cost of having an exact
genomic position for each read.
