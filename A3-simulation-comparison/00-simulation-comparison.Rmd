...
ggsave(here("figures/sim-timings.pdf"), p1, height = 6, width = 8)
ggsave(here("figures/sim-timings.png"), p1, height = 6, width = 8)

knitr::include_graphics(here::here("figures/sim-timings.png"))
```
