...
scRNA-tools database taking the total to XXX. Figure \@ref(fig:tools) shows an
overview to the current database as of XXX. Overall the analysis landscape has
not changed significantly over the last few months.
