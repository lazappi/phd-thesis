...
questions like how many tools perform a particular task, which areas developers
were focusing on or was there a tool for doing a particular task I began to
record details about them. Inspired by similar projects such as Sean Davis'
...
(https://scRNA-tools.org). A paper published in _PLoS Computational Biology_
...
visualisation of data and results. Developers of scRNA-seq analysis tools tend
to embrace a open-source and open-science approach. Most tools are developed on
GitHub were others can ask questions and submit improvements. The majority are
...
preprint publication, making them available to the community much more quickly
and giving early adopters a chance to contribute to their development.

A section at the end of this chapter (Section \@ref(tools-current)) presents an
updated version of some of this analysis based on the most recent version of
the database and details about the usage of the scRNA-tools website.
