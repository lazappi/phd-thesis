...
space. When there are more than a few hundred cells it is difficult to look at
the velocity for each individual cell so it can be useful to summarise them in
some way. Velocyto calculates a velocity field across the whole dataset by
forming a regular grid of points and using gaussian smoothing to calculate an
average of the nearby cells, providing an indication of the overall velocity of
an area (Figure \@ref(fig:cell-velocity)).
