...
related just to the number of reads per cells they may not have been detected
...
simulation based approach implemented in scran. This method create synthetic
...
using the technical metrics such as total counts per cells rather than gene
...
quality control method is valuable it will required more work to identify which
