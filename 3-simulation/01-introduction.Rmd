...
simulation models (**Section \@ref(splatter-update)**). A vignette describing
the use of Splatter is included as **Appendix \@ref(splatter-vignette)** and
the full manual in **Appendix \@ref(splatter-manual)**.
